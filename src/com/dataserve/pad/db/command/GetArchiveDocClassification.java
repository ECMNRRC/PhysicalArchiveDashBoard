...
public class GetArchiveDocClassification extends CommandBase{

	

	public GetArchiveDocClassification(HttpServletRequest request) {
		super(request);
	}
	...
	public String execute() throws Exception {
		try {
			...
			List<Map<String, Object>> departmentCounts = transferFilesManager.getArchiveDocClassification(currentUserId, departmentName);
	
			JSONArray arr = new JSONArray();
			for (Map<String, Object> deptData : departmentCounts) {
				JSONObject deptJson = new JSONObject();
				deptJson.put("classArName", deptData.get("classArName"));
