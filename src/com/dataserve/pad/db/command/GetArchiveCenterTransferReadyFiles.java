...
public class GetArchiveCenterTransferReadyFiles extends CommandBase{
	...
	public String execute() throws Exception {
		try {
			...
			Set<DmsFiles> files = transferFilesManager.getArchiveCenterTransferReadyFiles(currentUserId);
			...
			throw new Exception("Error Get Archive Center Transfer Ready Files for user with username '" + currentUserId + "'", e);
		}
	}
