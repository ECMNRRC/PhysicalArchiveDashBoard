...
public class GetArchiveDocDepartment extends CommandBase{

	

	public GetArchiveDocDepartment(HttpServletRequest request) {
		super(request);
	}
	...
	public String execute() throws Exception {
		try {
			...
			List<Map<String, Object>> departmentCounts = transferFilesManager.getArchiveDocDepartment(currentUserId, departmentName);
