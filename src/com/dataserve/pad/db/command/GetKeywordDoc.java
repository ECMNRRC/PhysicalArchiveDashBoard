...
public class GetKeywordDoc extends CommandBase{
	
	public GetKeywordDoc(HttpServletRequest request) {
		super(request);
	}
    ...
    public String execute() throws Exception {
        try {
            Map<String, Integer> counts = AuditDataModel.getKeyWordDocCounts();
            JSONObject json = new JSONObject();
            json.put("TotalCount", counts.get("TotalCount"));
            json.put("keywordDocCount", counts.get("keywordDocCount"));
