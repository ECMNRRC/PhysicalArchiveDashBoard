 ...
 * <p>
 */
public class PhysicalArchiveDashboardPlugin extends Plugin {
	 ...
	 */
	public String getId() {
		return "PhysicalArchiveDashboardPlugin";
	}
	...
	public String getName(Locale locale) {
		return "physical archive dashboard";
	}
	...
	public String getScript() {
		return "PhysicalArchiveDashboardPlugin.js";
	}
	...
	public String getDojoModule() {
		return "physicalArchiveDashboardPluginDojo";
	}
	...
	public String getCSSFileName() {
		return "PhysicalArchiveDashboardPlugin.css";
	}
	...
	public String getConfigurationDijitClass() {
		return "physicalArchiveDashboardPluginDojo.ConfigurationPane";
	}
	...
	/**
	    ...
	    public PluginFeature[] getFeatures() {
	    	if (pluginFeatures.length == 0) {
				pluginFeatures = new PluginFeature[] {new com.dataserve.pad.PhysicalArchiveDashboardFeature()};
			}
