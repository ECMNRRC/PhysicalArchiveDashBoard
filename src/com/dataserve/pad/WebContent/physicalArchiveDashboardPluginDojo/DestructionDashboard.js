define([
    ...
    return declare("physicalArchiveDashboardPluginDojo.DestructionDashboard", null, {
        ...
        getArchiveCenterTransferReadyFiles: function() {
        	var toaster = new Toaster();
        	params = {
        ...
        getArchiveCenterTransferReadyFilesTable: function () {
            const data = this.getArchiveCenterTransferReadyFiles();
        ...
        getDestoredFilesTable: function () {        	
            const data = this.getDestoredFiles();
            const totalDocsInsys = this.GetTotalDocsInSystem();
