define([
	...
	function(declare, _TemplatedMixin, _WidgetsInTemplateMixin, PluginConfigurationPane, template) {
		...
		/**
		 * @name PhysicalArchiveDashboardPluginDojo.FeatureConfigurationPane
		 * @class 
		 * @augments ecm.widget.admin.PluginConfigurationPane
		 */
		return declare("PhysicalArchiveDashboardPluginDojo.FeatureConfigurationPane", [ PluginConfigurationPane, _TemplatedMixin, _WidgetsInTemplateMixin], {
		/** @lends PhysicalArchiveDashboardPluginDojo.ConfigurationPane.prototype */
